...
class Parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = unpackFromStrings(
      new String[] { "\000\017\000\002\002\004\000\002\002\004\000\002\002" + "\005\000\002\005\005\000\002\005\007\000\002\003\004"
          + "\000\002\003\005\000\002\006\003\000\002\006\005\000" + "\002\004\003\000\002\004\003\000\002\004\003\000\002"
  ...
  protected static final short[][] _action_table = unpackFromStrings(
      new String[] { "\000\031\000\004\004\005\001\002\000\004\002\033\001" + "\002\000\006\005\010\013\006\001\002\000\004\010\012"
          + "\001\002\000\004\005\011\001\002\000\012\002\001\005" + "\001\007\001\011\001\001\002\000\012\002\uffff\005\uffff"
          + "\007\uffff\011\uffff\001\002\000\016\004\005\006\022\012" + "\013\013\017\014\014\015\016\001\002\000\010\005\ufff7"
          + "\007\ufff7\011\ufff7\001\002\000\010\005\ufff6\007\ufff6\011" + "\ufff6\001\002\000\010\005\ufff4\007\ufff4\011\ufff4\001\002"
          + "\000\010\005\ufff5\007\ufff5\011\ufff5\001\002\000\010\005" + "\ufff8\007\ufff8\011\ufff8\001\002\000\010\005\ufff3\007\ufff3"
          + "\011\ufff3\001\002\000\006\005\ufffe\011\031\001\002\000" + "\020\004\005\006\022\007\024\012\013\013\017\014\014"
          + "\015\016\001\002\000\004\007\030\001\002\000\010\005" + "\ufffc\007\ufffc\011\ufffc\001\002\000\006\007\ufffa\011\026"
          + "\001\002\000\016\004\005\006\022\012\013\013\017\014" + "\014\015\016\001\002\000\004\007\ufff9\001\002\000\010"
          + "\005\ufffb\007\ufffb\011\ufffb\001\002\000\004\013\006\001" + "\002\000\004\005\ufffd\001\002\000\004\002\000\001\002" + "" });
  ...
  protected static final short[][] _reduce_table = unpackFromStrings(
      new String[] { "\000\031\000\004\002\003\001\001\000\002\001\001\000" + "\004\005\006\001\001\000\002\001\001\000\002\001\001"
          + "\000\002\001\001\000\002\001\001\000\010\002\014\003" + "\017\004\020\001\001\000\002\001\001\000\002\001\001"
          + "\000\002\001\001\000\002\001\001\000\002\001\001\000" + "\002\001\001\000\002\001\001\000\012\002\014\003\017"
          + "\004\024\006\022\001\001\000\002\001\001\000\002\001" + "\001\000\002\001\001\000\012\002\014\003\017\004\024"
          + "\006\026\001\001\000\002\001\001\000\002\001\001\000" + "\004\005\031\001\001\000\002\001\001\000\002\001\001" + "" });
  ...
  class CUP$Parser$actions {
    ...
    public final java_cup.runtime.Symbol CUP$Parser$do_action_part00000000(int CUP$Parser$act_num,
        java_cup.runtime.lr_parser CUP$Parser$parser, java.util.Stack CUP$Parser$stack, int CUP$Parser$top) throws java.lang.Exception {
      ...
      switch (CUP$Parser$act_num) {
        ...
        case 0: // object ::= LCURLY RCURLY
        {
          ...
          CUP$Parser$result = this.parser.getSymbolFactory().newSymbol("object", 0,
        ...
        case 1: // $START ::= object EOF
        {
          ...
          RESULT = start_val;
          CUP$Parser$result = this.parser.getSymbolFactory().newSymbol("$START", 0,
              ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
              ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
        }
          /* ACCEPT */
        ...
        case 2: // object ::= LCURLY members RCURLY
        {
          ...
          Map<String, JsonEntity> m = (Map<String, JsonEntity>) ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(
        ...
        case 3: // members ::= STRING COLON value
        {
          ...
          Map<String, JsonEntity> m = new HashMap<>();
          m.put(key, val);
          RESULT = m;
          CUP$Parser$result = this.parser.getSymbolFactory().newSymbol("members", 3,
              ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
              ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
        }
          return CUP$Parser$result;
        ...
        case 5: // array ::= LBRACKET RBRACKET
        {
          ...
          CUP$Parser$result = this.parser.getSymbolFactory().newSymbol("array", 1,
              ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
              ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
        }
          return CUP$Parser$result;
        ...
        case 7: // elements ::= value
        {
          ...
          int valright = ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).right;
          JsonEntity val = (JsonEntity) ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
          List<JsonEntity> elems = new ArrayList<>();
          elems.add(val);
          RESULT = elems;
          CUP$Parser$result = this.parser.getSymbolFactory().newSymbol("elements", 4, ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
              ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
        }
          return CUP$Parser$result;
        ...
        case 8: // elements ::= value COMMA elements
        {
          ...
          elems.add(0, val);
          RESULT = elems;
          CUP$Parser$result = this.parser.getSymbolFactory().newSymbol("elements", 4,
              ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
              ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
        }
          return CUP$Parser$result;
    ...
    public final java_cup.runtime.Symbol CUP$Parser$do_action(int CUP$Parser$act_num, java_cup.runtime.lr_parser CUP$Parser$parser,
